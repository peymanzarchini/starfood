...
import { useAuth, loginSchema, type LoginFormValues } from "@/modules/auth";
        ...
        <div className="bg-bg-surface dark:bg-dark-bg-surface p-8 md:p-10 rounded-[2.5rem] shadow-xl border border-slate-100 dark:border-slate-800">
          ...
          <form onSubmit={handleSubmit(onSubmit)} className="space-y-5">
            ...
            <button
              type="submit"
              disabled={isLoading}
              className="w-full py-4 bg-primary text-white rounded-2xl font-black shadow-lg shadow-primary/30 hover:bg-primary-hover hover:scale-[1.02] active:scale-95 transition-all flex items-center justify-center gap-x-2 disabled:opacity-70 mt-4 cursor-pointer"
            >
              {isLoading ? (
