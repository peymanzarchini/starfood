...
import type { Cart, AddToCartInput, UpdateCartItemInput, PreviewDiscountResponse } from "../types";
...
export const cartApi = {
  ...
  previewDiscount: async (code: string): Promise<PreviewDiscountResponse> => {
    const response = await apiClient.get<ApiResponse<PreviewDiscountResponse>>(
